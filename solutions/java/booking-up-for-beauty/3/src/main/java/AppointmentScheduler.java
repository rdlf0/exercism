...
class AppointmentScheduler {
    private static final DateTimeFormatter SCHEDULE_DATE_FORMATER =
            DateTimeFormatter.ofPattern("MM/dd/yyyy HH:mm:ss");
    private static final DateTimeFormatter DESCRIPTION_FORMATER =
    ...
    public LocalDateTime schedule(final String appointmentDateDescription) {
        return LocalDateTime.parse(appointmentDateDescription, SCHEDULE_DATE_FORMATER);
    }
    ...
    public String getDescription(final LocalDateTime appointmentDate) {
        return appointmentDate.format(DESCRIPTION_FORMATER);
    }
